...
const resetAdmins = async () => {
  try {
    ...
    const newAdminUsername = "FGDCBAdmin"; // ✏️ change this
    const newAdminPassword = "FGDCB..Admin123"; // ✏️ change this
    ...
    console.log("✅ Old admins removed and new admin created successfully!");
