...
const createFaculty = async (req, res) => {
  ...
  try {
    ...
    if (!name || !designation || (!department && designation !== "Administration")) {
    ...
    const facultyData = {
      name,
      designation,
      department: designation === "Administration" ? null : department,
      email,
      phone,
      experience,
      qualifications,
      ...
      bio,
      status: status || "Ragular",
      adminType: designation === "Administration" ? adminType : null,
...
const updateFaculty = async (req, res) => {
  try {
    ...
    // Handle department/adminType logic
if (designation === "Administration") {
  faculty.adminType = adminType || faculty.adminType || "";
  faculty.department = ""; // clear department if switching to admin
} else {
  faculty.department = department || faculty.department || "";
  faculty.adminType = ""; // clear adminType if switching to faculty
}
    faculty.email = email || "";
    faculty.phone = phone || "";
